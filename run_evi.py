...
system_prompt = "Hello! I'm EVI, your empathic voice assistant. How can I assist you today?"
...
def on_message(message):
    ...
    # Add special instructions for handling user messages
    # if msg_type == "user_message":
    #     print("Hey this is a user message")
    #     top_emotions = get_top_n_emotions(prosody_inferences=scores, number=3)
        
        


        # store response if its for a question.
        # then we can use the response and the emotional data to do analysis on the user
...
async def main() -> None:
    try:
        ...
        async with client.connect_with_handlers(
            config_id='27132f25-31f8-4ea7-915e-97ad44af0ea0',
